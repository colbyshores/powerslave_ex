...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --cross-prefix=/usr/local/vitasdk/bin/arm-vita-eabi- --disable-shared --disable-runtime-cpudetect --disable-armv5te --disable-programs --disable-doc --disable-network --enable-libmp3lame --disable-everything --enable-decoder='aac,alac,ape,ac3,flac,mp3,mpeg4,opus,pcm_s16le,pcm_s24le,pcm_s32le,pcm_s8,pcm_u8,tta,vorbis,wmalossless,wavpack' --enable-demuxer='aac,ac3,aiff,ape,asf,avi,caf,flac,matroska,mp3,mp4,m4a,pcm_s16le,pcm_s24le,pcm_s32le,pcm_s8,pcm_u8,ogg,opus,tta,wav,webm,wv' --enable-muxer='aac,ac3,aiff,ape,asf,avi,caf,flac,matroska,mp3,mp4,m4a,pcm_s16le,pcm_s24le,pcm_s32le,pcm_s8,pcm_u8,ogg,opus,tta,wav,webm,wv' --enable-encoder='aac,alac,ape,ac3,flac,libmp3lame,mpeg4,opus,pcm_s16le,pcm_s24le,pcm_s32le,pcm_s8,pcm_u8,tta,vorbis,wmalossless,wavpack' --enable-parser='aac,ac3,flac,h263,mpeg4video,mpegaudio,opus,vorbis' --enable-protocol=file --enable-static --enable-small --disable-debug --arch=armv7-a --cpu=cortex-a9 --disable-armv6t2 --target-os=none --extra-cflags=' -Wl,-q -O2 -ftree-vectorize -fomit-frame-pointer -ffast-math -D_BSD_SOURCE' --extra-cxxflags=' -Wl,-q -O2 -ftree-vectorize -fomit-frame-pointer -ffast-math -fno-rtti -fno-exceptions -std=gnu++11 -D_BSD_SOURCE' --extra-ldflags=' -L/usr/local/vitasdk/lib ' --disable-bzlib --disable-iconv --disable-lzma --disable-sdl --disable-securetransport --disable-xlib
prefix=/usr/local
...
CC_IDENT=gcc 10.3.0 (GNU Tools for ARM Embedded Processors)
ARCH=arm
INTRINSICS=neon
CC=/usr/local/vitasdk/bin/arm-vita-eabi-gcc
CXX=/usr/local/vitasdk/bin/arm-vita-eabi-g++
AS=/usr/local/vitasdk/bin/arm-vita-eabi-gcc
LD=/usr/local/vitasdk/bin/arm-vita-eabi-gcc
DEPCC=/usr/local/vitasdk/bin/arm-vita-eabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/usr/local/vitasdk/bin/arm-vita-eabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
...
ARFLAGS=rcD
AR_O=$@
RANLIB=/usr/local/vitasdk/bin/arm-vita-eabi-ranlib -D
STRIP=/usr/local/vitasdk/bin/arm-vita-eabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -DZLIB_CONST
CFLAGS=  -Wl,-q -O2 -ftree-vectorize -fomit-frame-pointer -ffast-math -D_BSD_SOURCE -mcpu=cortex-a9 -std=c99 -fomit-frame-pointer -mthumb -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS= -Wl,-q -O2 -ftree-vectorize -fomit-frame-pointer -ffast-math -fno-rtti -fno-exceptions -std=gnu++11 -D_BSD_SOURCE -D__STDC_CONSTANT_MACROS
ASFLAGS=  -Wl,-q -O2 -ftree-vectorize -fomit-frame-pointer -ffast-math -D_BSD_SOURCE -mcpu=cortex-a9
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/usr/local/vitasdk/bin/arm-vita-eabi-windres
DEPWINDRES=/usr/local/vitasdk/bin/arm-vita-eabi-gcc
DOXYGEN=doxygen
LDFLAGS= -L/usr/local/vitasdk/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
...
EXTRALIBS=-lmp3lame -lm -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
